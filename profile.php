...
<head>
    ...
    <title><?php echo $settings_r['site_title'] ?? 'Site'; ?> - PROFILE</title>
</head>
            ...
            <div class="col-md-4 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="profile-form" enctype="multipart/form-data">
                        ...
                        <img src="<?php echo USERS_IMG_PATH . $u_fetch['profile'] ?>" class="mg-fluid">
                        <label class="form-label mt-3">New Picture</label>
                        <input name="profile" accept=".jpg, .jpeg, .png, .webp" type="file"
