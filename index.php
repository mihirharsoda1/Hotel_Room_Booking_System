...
<body class="bg-light">
                    ...
                    while ($row = mysqli_fetch_assoc($review_res)) {
                        ...
                        echo <<<slides
                            <div class="swiper-slide bg-white p-4">
                                <div class="profile d-flex text-center align-items-center mb-3">
                                    <img src="$img_path$row[profile] " class="rounded-circle" loading="lazy" width="30px" height="30px">
            ...
            <div class="modal-content">
                <form id="recovery-form">
                    ...
                    <div class="modal-body">
                        <input type="email" name="email" class="form-control mb-3" readonly>
                        <input type="text" name="otp" class="form-control mb-3" placeholder="Enter OTP" required>
                        <input type="password" name="pass" class="form-control mb-3" placeholder="Enter new password" required>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-dark shadow-none">Update Password</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        recovery_form.addEventListener('submit', (e) => {
            ...
            data.append('otp', recovery_form.elements['otp'].value);
