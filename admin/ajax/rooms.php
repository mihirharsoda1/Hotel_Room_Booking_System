...
if (isset($_POST['edit_room'])) {
    ...
    $del_features = deleteRow("DELETE FROM `room_features` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
    $del_facilities = deleteRow("DELETE FROM `room_facilities` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
